# Price of Freedom Museum - Hugo Site TODO

## Admin / Setup
- [ ] Set up custom domain `priceoffreedom.us` for GitHub Pages
  - Add CNAME DNS record pointing `priceoffreedom.us` to `priceoffreedom.github.io`
